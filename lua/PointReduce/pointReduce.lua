...
function dPointLine(point1, point2, point3)
	local area1 = math.abs(0.5 * (point2.x * point3.y + point3.x * 
    point1.y + point1.x * point2.y - point3.x * point2.y - point1.x * 
    point3.y - point2.x * point1.y))
    
	local area = math.abs(0.5 *((point3.x - point1.x) * (point2.x - point1.x) + (point3.y - point1.y) * (point2.y - point1.y)))
	
	print (area1 .. " and " .. area)
